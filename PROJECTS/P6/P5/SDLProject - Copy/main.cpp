...
void Render() {
	...
	if (currentScene == sceneList[0]) {
		...
		Util::DrawText(&program, font, "Player has 3 lives.", 0.5, -0.25f, glm::vec3(-2.3f, -1, 0));
		Util::DrawText(&program, font, " Stars give extra jumps.", 0.5, -0.25f, glm::vec3(-2.8f, -0.5f, 0));
		Util::DrawText(&program, font, "Complete 3 levels to win.", 0.5, -0.25f, glm::vec3(-2.8f, -1.5f, 0));
